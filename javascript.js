...
class Videojuego {
    constructor (nombre, descripcion, genero, caracteristicas, imagen, alt, precio) {
    this.nombre = nombre;
...
juegos.forEach((juego) => {
    ...
    <div class="card-footer d-flex justify-content-center">
        <button class="btnComprar btn btn-info fw-semibold">COMPRAR POR $ ${juego.precio}</button>
    </div>
    </div>
    `
});
