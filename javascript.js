...
function agregarAlCarrito (videojuego) {
    let botonComprar = "";  
    catalogoJuegos.forEach((juego) => {botonComprar = document.getElementById(`btnComprar${juego.id}`)})
